$(document).ready(function () {
    $(".btn-delete").click(function () {
        ...
        Swal.fire({
            ...
            text: "Bạn có muốn xóa giới thiệu này không?",
            icon: "warning",
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "/Admin/About_64132077/Delete",
                    type: "POST",
                    data: { id: PostId },
                    ...
                    error: function () {
                        Swal.fire("Lỗi!", "Đã xảy ra lỗi khi xóa giới thiệu.", "error");
                    },
                });
            }
        });
    ...
    $(".btn-active").click(function (e) {
        ...
        $.ajax({
            url: "/Admin/About_64132077/ChangeStatus",
            type: "POST",
            data: { id: PostId },
            success: function (response) {
                if (response.success) {
