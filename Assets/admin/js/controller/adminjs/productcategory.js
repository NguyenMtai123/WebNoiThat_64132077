$(document).ready(function () {
    $('body').on('click', '#BtnDeleteAll', function (e) {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    url: '/Admin/ProductCategory_64132077/DeleteAll',
                    type: 'POST',
    ...
    $(".btn-delete").click(function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $.ajax({
                    url: "/Admin/ProductCategory_64132077/Delete",
                    type: "POST",
    ...
    $(".btn-active").click(function (e) {
        ...
        $.ajax({
            url: "/Admin/ProductCategory_64132077/ChangeStatus",
            type: "POST",
            data: { id: ProductCategoryId },
            success: function (response) {
                if (response.success) {
